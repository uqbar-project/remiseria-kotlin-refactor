...
// - el costo del viaje, que se calcula como la sumatoria de: 1. el costo base de la remisería (1.500)
//   + 2. la comisión qeu cobra cada remisero (cada remisero cobra 2 veces la cantidad de letras de su nombre
//   menos Pepe que cobra 20% fijo) y 3. el costo en base a la distancia que son 300 pesos por milla
//   (sí, se calcula en millas).
//
